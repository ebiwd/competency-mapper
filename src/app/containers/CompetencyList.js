  ...
  render() {
      ...
      data = data
        ...
        .map(item => {
          return Object.assign({}, item, {
            domains: item.domains.filter(domain =>
              domain.competencies.some(competency =>
                competency.title
                  .toLowerCase()
                  .includes(this.state.filter.toLowerCase())
                      ...
                      trigger={
                        <div>
                          <h5 style={{ cursor: 'pointer' }}>
                            ...
                            <i className="fas fa-expand float-right" />
                          </h5>
                        </div>
                      }
                      triggerWhenOpen={
                        <div>
                          <h5 style={{ cursor: 'pointer' }}>
                            ...
                            <i className="fas fa-minus-square float-right" />
                          </h5>
                        </div>
                      }
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <a
                            onClick={() => this.handleOpenModal(competency.id)}
                            href={
                                ...
                                if (attribute.type == def)
                                  return (
                                    ...
                                    >
                                      ...
                                      <span ref={'span' + attribute.id} hidden>
                                        <a
                                          data-toggle={
                                            'example-dropdown' + attribute.id
                                          }
                                        >
                                          {' '}
                                          <i
              ...
              <div className="row">
                ...
                <div className="column large-5">
                  <div className="callout notice industry-background white-color">
                    ...
                    <ul>
                      <li>
                        [CORBEL][C.12] - A competency from derived framewor will
                        display here{' '}
                      </li>
                    </ul>
                  </div>
                  <div className="callout notice training-background white-color">
                    ...
                    <ul>
                      <li>
                        <a href="/training/events/2018/bringing-data-life-data-management-biomolecular-sciences">
                          Bringing data to life: data management for the
                          biomolecular sciences
                        </a>
                      </li>
                      <li>
                        <a href="/training/online/course/biocuration-introduction">
                          Biocuration: An introduction
                        </a>
                      </li>
                      <li>
                        <a href="/training/events/2018/exploring-human-genetic-variation-0">
                          Exploring Human Genetic Variation
                        </a>
                      </li>
                      <li>
                        <a href="/training/online/course/cellular-microscopy-phenotype-ontology-cmpo-quick">
                          Cellular Microscopy Phenotype Ontology (CMPO): Quick
                          tour
                        </a>
                      </li>
                    </ul>
    ...
    if (this.state.filter2) {
      resources = resources.filter(
        item =>
          item.title.toLowerCase().includes(this.state.filter2.toLowerCase()) ||
          item.keywords
            .toLocaleLowerCase()
            .includes(this.state.filter2.toLowerCase()) ||
          item.type
            .toLocaleLowerCase()
            .includes(this.state.filter2.toLowerCase()) ||
          item.description
          ...
          return (
            <tr key={index}>
              <td>
                <a
                  href={
                    process.env.PUBLIC_URL + '/#/training-resources/' + item.id
                  }
                >
                  {' '}
                  {item.title}{' '}
      ...
      <div key={1234}>
        ...
        <Tabs>
          ...
          <TabPanel>
            ...
            <table>{ListOfCompetencies}</table>
            ...
            <div>
              ...
              >
                ...
                >
                  <h2 className="services-background white-color">
                    Competency details{' '}
                    <i

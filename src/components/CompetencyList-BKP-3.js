...
class CompetencyList extends React.Component {
  ...
  componentDidMount() {
    ...
    let fetchCompetencyList =
      'http://drupal8/api/v1/framework/' + frameworkID + '?_format=json';
  ...
  render() {
                ...
                <Collapsible
                  trigger={
                    <h5 style={{ cursor: 'pointer' }}>
                      [ {did + 1}.{cid + 1} ] {competency.title}{' '}
                    </h5>
                  }
                >
                  <ul
                    className="no-bullet callout"
                  ...
                  >
                    <li className="float-right">
                      ...
                      >
                        {' '}
                        <i className="icon icon-common" data-icon="&#x2b;" />
                        More details
                      </button>
                    </li>
    ...
    return (
      <div key={1234}>
        ...
        {data.map(item => ListOfCompetencies)}
        <div>
          <ReactModal
